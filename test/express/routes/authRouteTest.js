...
describe('auth route use case test', function () {
    ...
    describe('#post:/members/:memberID/check-member-permission\n' +
        ...
        context('request for check member permission', function () {
            it('should response message with errcode:FAIL if no such member', function (done) {
            ...
            it('should response message with errcode:FAIL if no such permission', function (done) {
            ...
            it('should response message with errcode:true if success', function (done) {
                var memberID = "memberID";
                var body = {
                    permissionID: "permissionID"
                };
        ...
        'input:{memberID:""}\n' +
        'output:{errcode:0,errmsg:"",memberData:""}', function () {
        context('request for check member permission', function () {
            it('should response message with errcode:FAIL if no such member', function (done) {
                var memberID = "noMemberID";
                var body = {};
